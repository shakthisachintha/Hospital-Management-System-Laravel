...
<body>
    ...
    <div class="container">
        <section class="content">
            <div class="row">
                <div class="col-md-3">
                    <button onclick="window.history.back()" class="mt-5 btn-sm btn btn-success no-print"><i class="fa fa-arrow-left"></i> Back </button>
                    <button onclick="window.print()" class="mt-5 btn-sm btn btn-warning no-print">Print <i class="fas fa-print"></i></button>
                </div>
            </div>
            <br>
