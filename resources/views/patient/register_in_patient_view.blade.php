    ...
    <form class="form-horizontal">
        <form class="form-horizontal">
            <div class="box-body">
                ...
                <div class="form-group">
                    <label for="inputPassword3" class="col-sm-2 control-label">Address <span
                            style="color:red">*</span></label>
                    <div class="col-sm-10">
        ...
        <div class="p-2 mt-5 ml-1 mr-1">
            <button type="button" class="btn btn-block btn-success btn-md" onclick="reginpatientform2function()">Notes
                of Admitting Officer</button>
            <br>
            <button type="button" class="btn btn-block btn-success btn-md"
                onclick="reginpatientform3function()">Abstract of case by Medical officer</button>
        </div>
</div>
</form>
